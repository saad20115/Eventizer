...
export default function VendorReviewsPage() {
    ...
    return (
        <div className="animate-fadeInUp">
            <h1 className="text-2xl font-bold mb-6 text-gray-900">{t.dashboard.reviews}</h1>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 min-h-[400px] flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">تقييمات العملاء</h3>
                <p className="text-gray-500 max-w-md">
                    تابع آراء العملاء في خدماتك وقم بالرد عليها لتحسين سمعتك.
                </p>
            </div>
        </div>
    );
